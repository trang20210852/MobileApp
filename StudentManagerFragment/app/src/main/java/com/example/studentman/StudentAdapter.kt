...
class StudentAdapter(
  ...
  // Phương thức để cập nhật danh sách sinh viên trong Adapter
  fun updateStudentList(newStudents: List<StudentModel>) {
    (students as? MutableList)?.clear()
    (students as? MutableList)?.addAll(newStudents)
